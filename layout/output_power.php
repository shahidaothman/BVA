              ...
              <div id="exTab3" class="container mt-5">
                  <div class="row" style="flex-flow: row-reverse;">
                      <ul class="nav nav-pills " style="display: contents;">
                          ...
                          <li><a href="#6yp" data-toggle="tab">25Y</a>
                          </li>
                          <li><a href="#5yp" data-toggle="tab">20Y</a>
                          </li>
                          <li><a href="#4yp" data-toggle="tab">15Y</a>
                          </li>
                          <li><a href="#3yp" data-toggle="tab">10Y</a>
                          </li>
                          <li><a href="#2yp" data-toggle="tab">5Y</a>
                          </li>
